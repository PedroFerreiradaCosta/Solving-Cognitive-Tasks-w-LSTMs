...
def main(load_data, folder)
    ...
    root_logdir = "../output"
    logdir = "{}/{}/".format(root_logdir, folder)
    evaluate_path = logdir+'/evaluate/'
    ...
    if not os.path.exists(evaluate_path):
        os.makedirs(evaluate_path)
        os.makedirs(evaluate_path+"images_output")
        os.makedirs(evaluate_path+"images_hidden_c1")
        os.makedirs(evaluate_path+"images_hidden_c2")
        os.makedirs(evaluate_path+"images_hidden_lstm")
    ...
    weights = []
    weights.append(np.loadtxt('../output/'+file_weights+'/outputs/output_weights0.csv',delimiter=','))
    weights.append(np.loadtxt('../output/'+file_weights+'/outputs/output_weights1.csv',delimiter=','))
    weights.append(np.loadtxt('../output/'+file_weights+'/outputs/output_weights2.csv',delimiter=','))
    weights.append(np.loadtxt('../output/'+file_weights+'/outputs/output_weights3.csv',delimiter=','))
    weights.append(np.loadtxt('../output/'+file_weights+'/outputs/output_weights4.csv',delimiter=','))
    weights.append(np.loadtxt('../output/'+file_weights+'/outputs/output_weights5.csv',delimiter=','))
    weights.append(np.loadtxt('../output/'+file_weights+'/outputs/output_weights6.csv',delimiter=','))
    weights.append(np.loadtxt('../output/'+file_weights+'/outputs/output_weights7.csv',delimiter=','))
    ...
    file = open(logdir + "Evaluate_Model.txt", "w")
    ...
    for n in range(n_epoch):
        ...
        print(" " + str(n+1) + "/" + str(n_epoch))
        file.write(" " + str(n+1) + "/" + str(n_epoch) + '\n')
        model_out.summary()
        ...
        print('Mean accuracy = {0:.2f}'.format(np.mean(mean_ep_acc)))
    ...
    plt.ylabel('accuracy')
    plt.xlabel('trial')
    plt.savefig(evaluate_path + 'model_loss_accuracy.png')
    plt.close()
    np.savetxt(evaluate_path + 'model_acc.csv',mean_ep_acc,fmt="%1.2f",delimiter=',')
    ...
    for i in range(trn_trials):
        if i % 1 == 0:
            ...
            plt.title('Y_hat')
            plt.colorbar()
            plt.savefig(evaluate_path + 'images_output/train_trial_'+str(i)+'_task_' + str(states[i]['task']) + '.png')
            plt.close()

            plt.imshow(np.reshape(pred_hidden_c1[i,:,:],(Tx,h_units1)),cmap="viridis")
            plt.colorbar()
            plt.savefig(evaluate_path + 'images_hidden_c1/train_trial_'+str(i)+'_task_' + str(states[i]['task'])+'.png')
            plt.close()
            np.savetxt(evaluate_path + 'images_hidden_c1/train_trial_'+str(i)+'_task_' + str(states[i]['task'])+'.csv', np.reshape(pred_hidden_c1[i,:,:],(Tx,h_units1)), fmt="%1.2f", delimiter = ',')

            plt.imshow(np.reshape(pred_hidden_c2[i,:,:],(Tx,h_units2)),cmap="viridis")
            plt.colorbar()
            plt.savefig(evaluate_path + 'images_hidden_c2/train_trial_'+str(i)+'_task_' + str(states[i]['task'])+'.png')
            plt.close()
            np.savetxt(evaluate_path + 'images_hidden_c2/train_trial_'+str(i)+'_task_' + str(states[i]['task'])+'.csv', np.reshape(pred_hidden_c2[i,:,:],(Tx,h_units2)), fmt="%1.2f", delimiter = ',')

            plt.imshow(np.reshape(pred_hidden_lstm[i,:,:],(Tx,h_units1)),cmap="viridis")
            plt.colorbar()
            plt.savefig(evaluate_path + 'images_hidden_lstm/train_trial_'+str(i)+'_task_' + str(states[i]['task'])+'.png')
            plt.close()
            np.savetxt(evaluate_path + 'images_hidden_lstm/train_trial_'+str(i)+'_task_' + str(states[i]['task'])+'.csv', np.reshape(pred_hidden_lstm[i,:,:],(Tx,h_units1)), fmt="%1.2f", delimiter = ',')
    ...
    print('[INFO] Generating reduced space for 1st layer cell...')
    ...
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c1_task.png')
    plt.show()

    plt.scatter(encoded_hidden_c1[:,0],encoded_hidden_c1[:,1], c=stim1_dir)
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c1_stim1_dir.png')
    plt.show()

    plt.scatter(encoded_hidden_c1[:,0],encoded_hidden_c1[:,1], c=stim_mod.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c1_stim1_mod.png')
    plt.show()

    plt.scatter(encoded_hidden_c1[:,0],encoded_hidden_c1[:,1], c=Tstim1.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c1_Tstim1.png')
    plt.show()

    plt.scatter(encoded_hidden_c1[:,0],encoded_hidden_c1[:,1], c=Tdelay.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c1_Tdelay.png')
    plt.show()

    plt.scatter(encoded_hidden_c1[:,0],encoded_hidden_c1[:,1], c=stim2_dir.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c1_stim2_dir.png')
    plt.show()

    plt.scatter(encoded_hidden_c1[:,0],encoded_hidden_c1[:,1], c=stim2_mod.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c1_stim2_mod.png')
    plt.show()

    plt.scatter(encoded_hidden_c1[:,0],encoded_hidden_c1[:,1], c=Tgo.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c1_Tgo.png')
    plt.show()

    print('[INFO] Generating reduced space for 2nd layer cell...')
    ...
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c2_task.png')
    plt.show()

    plt.scatter(encoded_hidden_c2[:,0],encoded_hidden_c2[:,1], c=stim1_dir)
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c2_stim1_dir.png')
    plt.show()

    plt.scatter(encoded_hidden_c2[:,0],encoded_hidden_c2[:,1], c=stim_mod.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c2_stim_mod.png')
    plt.show()

    plt.scatter(encoded_hidden_c2[:,0],encoded_hidden_c2[:,1], c=Tstim1.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c2_Tstim1.png')
    plt.show()

    plt.scatter(encoded_hidden_c2[:,0],encoded_hidden_c2[:,1], c=Tdelay.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c2_Tdelay.png')
    plt.show()

    plt.scatter(encoded_hidden_c2[:,0],encoded_hidden_c2[:,1], c=stim2_dir.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c2_stim2_dir.png')
    plt.show()

    plt.scatter(encoded_hidden_c2[:,0],encoded_hidden_c2[:,1], c=stim2_mod.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c2_stim2_mod.png')
    plt.show()

    plt.scatter(encoded_hidden_c2[:,0],encoded_hidden_c2[:,1], c=Tgo.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_c2_Tgo.png')
    plt.show()

    print('[INFO] Generating reduced space for 1st layer output...')
    ...
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_lstm1_task.png')
    plt.show()

    plt.scatter(encoded_hidden_lstm[:,0],encoded_hidden_lstm[:,1], c=stim1_dir)
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_lstm1_stim1_dir.png')
    plt.show()

    plt.scatter(encoded_hidden_lstm[:,0],encoded_hidden_lstm[:,1], c=stim_mod.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_lstm1_stim_mod.png')
    plt.show()

    plt.scatter(encoded_hidden_lstm[:,0],encoded_hidden_lstm[:,1], c=Tstim1.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_lstm1_Tstim1.png')
    plt.show()

    plt.scatter(encoded_hidden_lstm[:,0],encoded_hidden_lstm[:,1], c=Tdelay.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_lstm1_Tdelay.png')
    plt.show()

    plt.scatter(encoded_hidden_lstm[:,0],encoded_hidden_lstm[:,1], c=stim2_dir.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_lstm1_stim2_dir.png')
    plt.show()

    plt.scatter(encoded_hidden_lstm[:,0],encoded_hidden_lstm[:,1], c=stim2_mod.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_lstm1_stim2_mod.png')
    plt.show()

    plt.scatter(encoded_hidden_lstm[:,0],encoded_hidden_lstm[:,1], c=Tgo.ravel())
    plt.colorbar()
    plt.savefig(evaluate_path + 'trn_tsne_hidden_lstm1_Tgo.png')
    plt.show()

    print('[INFO] Generating reduced space for 2nd layer output...')
